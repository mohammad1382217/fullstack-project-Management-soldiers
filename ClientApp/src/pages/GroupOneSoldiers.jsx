...
const GroupOneSoldiers = () => {
  ...
  return (
    <div>
      <header>
        <HeaderTop NavTitle="آمار سربازان گروه الف" />
        <Menu />
      </header>
      <main>
        <div className={"h-full max-[768px]:mr-0" + (showMenu ? " mr-64" : " mr-[4.25rem]")}>
          <div className="py-4 px-4">
            <div className="container px-4">
              <HeaderBottom titr="آمار سربازان گروه الف" />
            </div>
            <Table data={GroupOne} />
          </div>
        </div>
...
export default GroupOneSoldiers;
