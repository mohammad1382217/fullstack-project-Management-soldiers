...
const CommandSoldiers = () => {
  ...
  return (
    <div>
      <header>
        <HeaderTop NavTitle="اطلاعات سربازان فرماندهی" />
        <Menu />
      </header>
      <main>
        <div className={"h-full max-[768px]:mr-0" + (showMenu ? " mr-64" : " mr-[4.25rem]")}>
          <div className="py-4 px-4">
            <div className="container px-4">
              <HeaderBottom titr="سرباز فرماندهی" redirect={"/AmadSoldier"} />
            </div>
            <Table data={Command}/>
          </div>
        </div>
...
export default CommandSoldiers;